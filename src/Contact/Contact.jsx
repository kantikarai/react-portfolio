        ...
        <div className="contact-container">
          ...
          <div className="follow" data-aos="fade-right">
            ...
            <ul data-aos="zoom-in" data-aos-delay="200">
              <li><a href="https://github.com/kantikarai" aria-label="GitHub"><i className="fab fa-github"></i></a></li>
              <li><a href="https://www.linkedin.com/in/" aria-label="LinkedIn"><i className="fab fa-linkedin-in"></i></a></li>
              <li><a href="https://www.youtube.com/" aria-label="youtube"><i className="fab fa-youtube"></i></a></li>
            </ul>
          </div>
